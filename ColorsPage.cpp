...
CColorsPage::CColorsPage(void) :  CSettings(_Settings) 
{
  m_psp.dwFlags |= PSP_HASHELP;
}

CColorsPage::~CColorsPage(void)
{
}


LRESULT CColorsPage::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
int CColorsPage::OnApply()
{
	...
	else
	{
		...
		::PostMessage(GetParent(),WM_DIZ_MAPCHANGED,0,1);
...
/*
BOOL CColorsPage::PreTranslateMessage(MSG* pMsg)
{
	return IsDialogMessage(pMsg);
}
*/

LRESULT CColorsPage::OnCtlColorStatic(UINT /*uMsg*/, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
{
...
LRESULT CColorsPage::OnStnClickedColor(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	COLORREF *pColor;
	switch (wID)
	{
...
LRESULT CColorsPage::OnCtlColorListbox(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	COLORREF color(0);
...
LRESULT CColorsPage::OnDrawItem(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
...
LRESULT CColorsPage::OnLbnSelchangeCollist(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& /*bHandled*/)
{
...
BOOL CColorsPage::DoDataExchange(BOOL bSaveAndValidate, UINT nCtlID)
{
bool bEnable[3];
...
LRESULT CColorsPage::OnBnClickedColors(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	DoDataExchange(1,IDC_COLORS1);
	return 0;
}

LRESULT CColorsPage::OnEnKillfocusNumcol(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
...
LRESULT CColorsPage::OnDeltaposSnumcol(int /*idCtrl*/, LPNMHDR pNMHDR, BOOL& /*bHandled*/)
{
	int C;
...
LRESULT CColorsPage::OnBnClickedBipolsepcolor(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
